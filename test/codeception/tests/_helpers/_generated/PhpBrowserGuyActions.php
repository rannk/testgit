...
use Codeception\Module\CurrentUrlHelper;
use Codeception\Module\LoginHelper;

trait PhpBrowserGuyActions
{
    /**
     ...
     *
     *
     * @see \Codeception\Module\CurrentUrlHelper::grabCurrentHost()
     */
    public function grabCurrentHost() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('grabCurrentHost', func_get_args()));
    }
     ...
     *
     *
     * @see \Codeception\Module\LoginHelper::logIn()
     */
