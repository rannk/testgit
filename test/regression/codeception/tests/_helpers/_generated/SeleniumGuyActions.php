...
use Codeception\Module\SeleniumHelper;

trait SeleniumGuyActions
{
    /**
     ...
     */
    public function waitForElement($element, $timeout = 30) {
     ...
     */
    public function waitForElementNotVisible($element, $timeout = 30) {
     ...
     */
    public function waitForText($text, $timeout = 30, $selector = null) {
     ...
     *
     * Conditional Assertion: Test won't be stopped on fail
     * @see \Codeception\Module\SeleniumHelper::seeTopOfPage()
     */
    public function canSeeTopOfPage($scroll_top) {
        return $this->getScenario()->runStep(new \Codeception\Step\ConditionalAssertion('seeTopOfPage', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     ...
     * @see \Codeception\Module\SeleniumHelper::seeTopOfPage()
     */
    public function seeTopOfPage($scroll_top) {
        return $this->getScenario()->runStep(new \Codeception\Step\Assertion('seeTopOfPage', func_get_args()));
    }
     ...
     *
     *
     * @see \Codeception\Module\SeleniumHelper::matchLink()
     */
    public function matchLink($source, $match) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('matchLink', func_get_args()));
    }
     ...
     *
     *
     * @see \Codeception\Module\SeleniumHelper::checkLinkContainText()
     */
    public function checkLinkContainText($link, $text) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('checkLinkContainText', func_get_args()));
    }
     ...
     *
     *
     * @see \Codeception\Module\SeleniumHelper::closeAds()
     */
    public function closeEmailAds() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('closeEmailAds', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     *
     * @see \Codeception\Module\SeleniumHelper::closePoe()
     */
    public function closePoe() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('closePoe', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     *
     * @see \Codeception\Module\SeleniumHelper::closeVideoAds()
     */
    public function closeVideoAds() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('closeVideoAds', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     *
     * @see \Codeception\Module\SeleniumHelper::closeMiscVideoAds()
     */
    public function closeMiscVideoAds() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('closeMiscVideoAds', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     *
     * @see \Codeception\Module\SeleniumHelper::closeMiscAds()
     */
    public function closeMiscAds() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('closeMiscAds', func_get_args()));
    }
    /**
     *
     * @see \Codeception\Module\SeleniumHelper::getJsLog()
     */
    ...
    /**
     * @see \Codeception\Module\SeleniumHelper::closePrivacyPolicyBanner()
     */
    public function closePrivacyPolicyBanner() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('closePrivacyPolicyBanner', func_get_args()));
    }
}
