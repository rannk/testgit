...
if [ $TRAVIS_BRANCH = "development" ]; then
    ...
    php $TEST_DIR/codeception/qaTools/devQAWrapper.phar -R -e dev4chromeEnv -c $TEST_DIR/codeception --detail_fail_cases --hostip 127.0.0.1 -p 4 --clear_data --detail_fail_cases -g sparkle-web --retry 2 | tee /tmp/test_result.t
